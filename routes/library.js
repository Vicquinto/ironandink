...
router.get('/library', requireAuth, (req, res) => {
  ...
  res.send(renderLayout({
    ...
    title: 'Library',
    content,
    scripts: '<script src="/js/study-badges.js?v=1"></script><script src="/js/render-markdown.js?v=1"></script><script src="/js/enhance-further-studies.js?v=2"></script><script src="/js/library.js?v=53"></script>',
  }));
});
