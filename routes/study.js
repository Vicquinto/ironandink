...
router.get('/study', requireAuth, (req, res) => {
  ...
  res.send(renderLayout({
    ...
    title: 'Study',
    content,
    scripts: `<script src="/js/render-markdown.js?v=1"></script><script src="/js/enhance-further-studies.js?v=2"></script><script src="/js/study.js?v=14"></script><script src="/js/library.js?v=45"></script>
<script>
